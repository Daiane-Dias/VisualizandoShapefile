package com.daiane.usandoshapefile;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void setupMapHidrografia() {
        //Aqui vai sua chave da api padrão do ARCGIS Desenvolvedor
        ArcGISRuntimeEnvironment.setApiKey("ABCDCQERT");
        ArcGISMap map = new ArcGISMap(BasemapStyle.ARCGIS_TOPOGRAPHIC);
        this.mMapView.setMap(map);
        //link da camada importada no ARCGIS develop
        ServiceFeatureTable shapefileFeatureTable = new ServiceFeatureTable("https://services.arcgis.com/Rstvcd");
